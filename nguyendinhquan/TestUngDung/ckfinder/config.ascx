...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "nguyenlinh";
        LicenseKey = "5STUUHGEVQEAEKK4SRWQL41HNGT2PRNC";
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "csv", "doc", "docx", "fla", "gz", "gzip", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
